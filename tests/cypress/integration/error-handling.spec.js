...
test(
    'x-init identifier issue',
    [
        html` <div id="xinit" x-data x-init="doesNotExist()"></div> `,
...
test(
    'x-show identifier issue',
    [
        html` <div id="xshow" x-data="{isOpen: true}" x-show="isVisible"></div> `,
...
test(
    'x-bind class object syntax identifier issue',
    [
        html`
...
test(
    'x-if identifier issue ( function )',
    [
        html`
...
test(
    'x-effect identifier issue',
    [
        html`
            <div
                id="xeffect"
                x-data="{ label: 'Hello' }"
                x-effect="System.out.println(label)"
            ></div>
        `,
...
test(
    'x-data syntax error',
    [
        html` <div id="xdata" x-data="{ label: 'Hello' }aaa"></div> `,
...
test(
    'x-data with reference error and multiple errors',
    [
        html`
