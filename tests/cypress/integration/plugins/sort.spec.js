...
test(
    ...
    [
        html`
            <div
                x-data="{ handle(key, position) { $refs.outlet.textContent = key+'-'+position } }"
            >
                <ul x-sort="handle">
...
test(
    'can access key and position in handler',
    [
        html`
            <div
                x-data="{ handle(key, position) { $refs.outlet.textContent = key+'-'+position } }"
...
test(
    'can use custom sortablejs configuration',
    [
        html`
            <div x-data>
