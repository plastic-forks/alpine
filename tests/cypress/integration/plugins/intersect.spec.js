...
test(
    'It should evaluate with ":enter" only when the component is intersected',
    [
        html`
            <div x-data="{ count: 0 }">
                <span x-text="count"></span>
...
test(
    'It should evaluate with ":leave" only when the component is not intersected',
    [
        html`
            <div x-data="{ count: 0 }">
                <span x-text="count"></span>
    ...
    [
        html`
            <div x-data="{ count: 0 }">
                ...
                <div
                    id="buffer-top"
                    style="height: calc(100vh - 50px); margin-top: 100vh; background: pink"
                ></div>
                <div id="buffer-bottom" style="height: 50px; background: green"></div>
                <div
                    x-intersect.margin.100px="count++;$nextTick(() => console.log(count))"
                    id="1"
                >
                    hi
                </div>
    ...
    [
        html`
            <div x-data="{ count: 0 }">
                <div
                    x-ref="foo"
                    style="width: 250px; overflow: scroll; display: flex; justify-content: start"
                >
