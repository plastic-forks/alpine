...
test(
    'can use arrow keys to cycle through tabs',
    [
        html`
            <div x-data x-tabs>
                <div x-tabs:list>
...
test(
    'cant tab through tabs, can only use arrows',
    [
        html`
            <div>
...
test(
    'can detect the selected tab & panel',
    [
        html`
            <div x-data x-tabs>
                <div x-tabs:list>
...
test(
    'can programmatically control the selected tab',
    [
        html`
