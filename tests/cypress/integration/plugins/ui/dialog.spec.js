...
test(
    'works with open prop and close event',
    [
        html`
            <div x-data="{ open: false }">
                <button @click="open = ! open">Toggle</button>
...
test(
    'x-dialog:panel allows for click away',
    [
        html`
            <div x-data="{ open: true }">
                ...
                <article x-dialog x-model="open">
                    <div x-dialog:panel>Dialog Contents!</div>
                </article>
            </div>
        `,
    ],
...
test(
    'x-dialog:overlay closes dialog when clicked on',
    [
        html`
            <div x-data="{ open: true }">
                <h1>Click away on me</h1>
                ...
                <article x-dialog x-model="open">
                    <main x-dialog:overlay>Some Overlay</main>
...
test(
    '$modal.open exposes internal "open" state',
    [
        html`
            <div x-data="{ open: false }">
                <button @click="open = ! open">Toggle</button>
