...
test(
    'popover can be rendered statically',
    [
        html`
            <div x-data x-popover>
                <button x-popover:button>Toggle</button>
...
test(
    'focusing away doesnt close panel if focusing inside a group',
    [
        html`
            <div x-data>
                <div x-popover:group>
...
test.retry(5)(
    'focusing away still closes panel inside a group if the focus attribute is present',
    [
        html`
            <div x-data>
                <div x-popover:group>
