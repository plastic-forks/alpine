    ...
    [
        html`
            <div x-data="{ checked: false }">
                ...
                <article x-show="checked">Notifications are enabled.</article>
            </div>
        `,
    ],
    ({ get }) => {
...
test(
    'works with internal state/$switch.isChecked',
    [
        html`
            <div x-data>
...
test(
    ...
    [
        html`
            <div x-data>
                <div>
                    <button x-switch name="notifications" value="yes">
                        Enable notifications
                    </button>
                </div>
            </div>
...
test(
    ...
    [
        html`
            <div x-data>
                <div>
                    <button x-switch name="notifications">Enable notifications</button>
                </div>
            </div>
        `,
    ],
