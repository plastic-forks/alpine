...
test(
    'teleported targets forward events to teleport source if listeners are attached',
    [
        html`
            <div x-data="{ count: 1 }" id="a">
                <button @click="count++">Inc</button>
...
test(
    'removing teleport source removes teleported target',
    [
        html`
            <div x-data="{ count: 1 }" id="a">
...
test(
    '$refs inside teleport can be accessed outside',
    [
        html`
            <div x-data="{ count: 1 }" id="a">
...
test(
    '$root is accessed outside teleport',
    [
        html`
            <div x-data="{ count: 1 }" id="a">
                <template x-teleport="#b">
...
test(
    '$id honors x-id outside teleport',
    [
        html`
